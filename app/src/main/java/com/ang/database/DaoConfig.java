...
import com.ang.database.KDB.DbUpdateListener;
import com.duoma.sql.BuildConfig;
...
final public class DaoConfig {
    ...
    private String mDbName = "kdb.db"; // 数据库名字
    private int dbVersion = 1; // 数据库版本
    private boolean debug = BuildConfig.DEBUG; // 是否是调试模式（调试模式 增删改查的时候显示SQL语句）
